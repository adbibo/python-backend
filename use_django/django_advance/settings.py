...
SECRET_KEY = '0q!83q!*!=$=&eay!&igb7v3j9%$cfh-@u1b4#akzwg6!k86_('
...
DATABASES = {
    ...
    'disk': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': config.get('disk', 'db_name'),
        'USER': config.get('disk', 'user'),
        'PASSWORD': config.get('disk', 'password'),
        'HOST': config.get('disk', 'host'),
        'PORT': config.get('disk', 'port'),
    },
